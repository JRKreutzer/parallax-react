...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_yoxbqel', 'template_m5gurhr', formRef.current, {
            publicKey: 'w8p5Cj4IsDicb07V6',
          })
          .then(
            () => {
              setSucess(true)
        ...
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer">
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Email</h2>
                    <span>email@react.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Endereço</h2>
                    <span>Rua 1 de Janeiro, Cidade</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Telefone</h2>
